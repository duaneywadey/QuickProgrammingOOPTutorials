...
<body>
	<h2 style="color: red">The student ID is <?php echo $_GET['student_id']; ?></h2>

	<?php $getStudentByID = getStudentByID($pdo, $_GET['student_id']); ?>
	<form action="core/handleForms.php?student_id=<?php echo $getStudentByID['student_id']; ?>" method="POST">
		<p>
