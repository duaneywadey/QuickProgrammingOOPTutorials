...
function insertIntoStudentRecords($pdo, $first_name, $last_name, $gender, $year_level, $section, $adviser, $religion) {

	$sql = "INSERT INTO student_records (first_name, last_name, gender, year_level, section, adviser, religion) VALUES(?,?,?,?,?,?,?)";

	$stmt = $pdo->prepare($sql);

	$executeQuery = $stmt->execute([$first_name, $last_name, $gender, $year_level, $section, $adviser, $religion]);
...
function updateAStudent($pdo, $student_id, $first_name, $last_name, $gender, $year_level, $section, $adviser, $religion) {
