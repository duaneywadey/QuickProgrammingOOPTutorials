...
function insertABranch($pdo, $address, $head_manager, $contact_number, $added_by) {
	...
	if ($insertBranch) {
		...
		$insertAnActivityLog = insertAnActivityLog($pdo, "INSERT", $getBranchID['branch_id'], $getBranchID['address'], $getBranchID['head_manager'], 
...
function updateBranch($pdo, $address, $head_manager, $contact_number, 
	...
	if ($updateBranch) {
		...
		$insertAnActivityLog = insertAnActivityLog($pdo, "UPDATE", $getBranchID['branch_id'], $getBranchID['address'], $getBranchID['head_manager'], 
			$getBranchID['contact_number'], $_SESSION['username']);
...
function deleteABranch($pdo, $branch_id) {
	...
	$insertAnActivityLog = insertAnActivityLog($pdo, "DELETE", $getBranchByID['branch_id'], $getBranchByID['address'], $getBranchByID['head_manager'], 
